...
<fieldset>
    <div class="content">
        ...
        <div class="col-5">
            ...
            <input autocomplete="off" type="text" data-provide="datepicker-inline" data-date-format="yyyy-mm-dd"
        ...
        <div class="col-5">
            <label id="passportNumber"><g:message code="workplace.endDate.label" default="Company"/></label>
        ...
        <div class="col-5">
            <label for="email"><g:message code="workplace.endDate.label" default="Company"/></label>
        ...
        <div class="col-5">
            <label for="phone"><g:message code="workplace.endDate.label" default="Company"/></label>
